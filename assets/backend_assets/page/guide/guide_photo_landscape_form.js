$(document).ready(function(){
    ...
    $("#file-upload").fileupload({
		...
		if (data.files.error) {
			...
			$('#px-guide-guide-fileupload-'+target+'-progress').text(progress+'%');
			$('#px-guide-guide-fileupload-'+target+'-upload-button').attr('disabled',true);
		}).on('fileuploaddone', function (e, data) {
			var target = $('#target-file').val();
			$('#px-guide-guide-fileupload-'+target+'-upload-button').removeAttr('disabled');
			...
			$('#px-guide-guide-fileupload-upload-button').removeAttr('disabled');
