								...
								<td class="text-center">
									<form action="<?php echo $controller.'/'.$function_form; ?>" method="post">
										...
										<button class="btn btn-info btn-xs btn-edit" type="submit" data-original-title="Ubah" data-placement="top" data-toggle="tooltip"><i class="fa fa-edit"></i></button>
								 		<a href="<?php echo $controller.'/album_image/'.$d_row->id; ?>" data-original-title="album Images" data-placement="top" data-toggle="tooltip" class="btn btn-xs btn-primary"><i class="fa fa-image"></i></a>
...
<!-- START SCRIPTS -->               
	...
	<script type="text/javascript" src="assets/backend_assets/page/site_content/album.js"></script>
	<!-- EOF PAGE SETTINGS  -->
<!-- END SCRIPTS -->   