                        ...
                        <tbody>
                            ...
                            foreach ($data as $d_row) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $d_row->ip_address; ?></td>
                                    <td class="text-center"><?php echo $d_row->browser; ?></td>
                                    <td class="text-center"><?php echo $d_row->counter; ?></td>
                                    <td class="text-center"><?php echo $d_row->date; ?></td>
                                </tr>
                                <?php $no++;
                            } ?>
                        </tbody>
