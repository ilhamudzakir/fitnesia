		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">                                
					...
					<a class="btn btn-success pull-right btn-add" href="<?php echo $controller.'/meta_data_form'; ?>"><i class="fa fa-plus"></i> Add New</a>
						...
						<tbody>
							...
							<tr>
								<td class="text-center"><?php echo $no; ?></td>
                                                                <td class="text-center"><?php echo $d_row->page; ?></td>
								<td class="text-center">
									<form action="<?php echo $controller.'/meta_data_form'; ?>" method="post">
...
<!-- MESSAGE BOX -->
<div id="px-admin_meta_data-meta_data-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/meta_data_delete' ?>" method="post" id="px-admin_meta_data-meta_data-message-form">
...
<!-- START SCRIPTS -->               
	...
	<script type="text/javascript" src="assets/backend_assets/page/meta_data/meta_data.js"></script>
	<!--  -->
<!-- END SCRIPTS -->   