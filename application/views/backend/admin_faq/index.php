		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">                                
					...
					<a class="btn btn-success pull-right btn-add" href="<?php echo $controller.'/faq_form'; ?>"><i class="fa fa-plus"></i> Add New</a>
						...
						<tbody>
							...
							<tr>
								<td class="text-center"><?php echo $no; ?></td>
                                                                ...
                                                                <td class="text-center"><?php echo $d_row->subtitle; ?></td>
								<td class="text-center">
									<form action="<?php echo $controller.'/faq_form'; ?>" method="post">
...
<!-- MESSAGE BOX -->
<div id="px-admin_faq-faq-message-box" class="message-box message-box-warning animated fadeIn fade">
	<div class="mb-container">
		<div class="mb-middle">
			<form action="<?php echo $controller.'/faq_delete' ?>" method="post" id="px-admin_faq-faq-message-form">
...
<!-- START SCRIPTS -->               
	...
	<script type="text/javascript" src="assets/backend_assets/page/faq/faq.js"></script>
	<!--  -->
<!-- END SCRIPTS -->   