                        ...
                        <tbody>
                            ...
                            foreach ($data as $d_row) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="admin_become_partners/detail/<?php echo $d_row->id ?>" class="btn btn-info btn-xs" data-original-title="Detail" data-placement="top" data-toggle="tooltip"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                <?php $no++;
                            } ?>
